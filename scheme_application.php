...
<div class="container-fluid">
    ...
    <form role="form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <p style="color: #ff0000; font-size: 150%;">B. Particulars regarding proposed Scheme</p>
        ...
        <div class="row">
            <p style="color: #ff0000; font-size: 150%;">C. Provide the following information regarding the proposed
                scheme</p>
